  ...
  return (
    <div className={`layout ${sidebarCollapsed ? "sidebar-collapsed" : ""}`}>
      <header className="topnavbar">
        <div className="topnavbar-left">
          <button className="sidebar-toggle" onClick={() => {
            if (isMobileWidth()) { setMobileSidebarOpen(prev => !prev); }
      ...
      <aside className={`sidebar ${mobileSidebarOpen ? "mobile-open" : ""}`}>
        <button className="sidebar-close" onClick={() => setMobileSidebarOpen(false)} aria-label="Tutup menu">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M18 6L6 18M6 6l12 12"/></svg>
        </button>
        <nav>
          <NavLink to="/" end onClick={() => { setProfileOpen(false); setMobileSidebarOpen(false); }}>
          ...
          <NavLink to="/resume-ralan" onClick={() => { setProfileOpen(false); setMobileSidebarOpen(false); }}>
          ...
          <NavLink to="/resume-ranap" onClick={() => { setProfileOpen(false); setMobileSidebarOpen(false); }}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <NavLink to="/laporan-operasi" onClick={() => { setProfileOpen(false); setMobileSidebarOpen(false); }}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <NavLink to="/laporan-resume" onClick={() => { setProfileOpen(false); setMobileSidebarOpen(false); }}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          {user?.role === "admin" && (
            <>
              <NavLink to="/users" onClick={() => { setProfileOpen(false); setMobileSidebarOpen(false); }}>
              ...
              <NavLink to="/audit-logs" onClick={() => { setProfileOpen(false); setMobileSidebarOpen(false); }}>
